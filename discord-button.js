(function () {
  ...
  // 2. Button ke Styles add karna
  const style = document.createElement("style");
  style.innerHTML = `
        .floating-discord-btn {
            position: fixed;
            bottom: 20px;
            right: 20px; /* Left me chahiye to 'left: 20px;' kar dein */
            width: 52px;
            height: 52px;
            ...
            z-index: 999999; /* Game canvas ke upar dikhne ke liye */
            cursor: pointer;
  ...
  // 3. Discord Button DOM me inject karna
